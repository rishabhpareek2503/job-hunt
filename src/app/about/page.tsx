...
export default function AboutPage() {
  return (
    <section className="min-h-screen w-full flex flex-col items-center justify-start bg-gradient-to-b from-background/80 to-background px-4 pt-10 pb-16">
      <div className="w-full max-w-3xl mx-auto flex flex-col items-center text-center">
        <div className="mb-6">
          <Image src="/logo.png" alt="Hirinex Logo" width={72} height={72} className="rounded-full mx-auto shadow-lg" />
        </div>
        <h1 className="text-3xl md:text-4xl font-extrabold text-primary mb-2">About <span className="text-foreground">Hirinex</span></h1>
        ...
        <div className="flex flex-col md:flex-row gap-8 w-full mb-10">
          <div className="flex-1 bg-card text-foreground rounded-2xl shadow-xl p-6 flex flex-col items-center border border-border backdrop-blur-md transition-all">
            <h2 className="text-xl font-bold text-primary mb-2">Our Mission</h2>
            <p className="text-muted-foreground text-base">To revolutionize the job search experience by providing a platform that is fast, fair, and focused on real results for both job seekers and employers.</p>
          </div>
          <div className="flex-1 bg-card text-foreground rounded-2xl shadow-xl p-6 flex flex-col items-center border border-border backdrop-blur-md transition-all">
            <h2 className="text-xl font-bold text-primary mb-2">Our Values</h2>
            <ul className="text-muted-foreground text-base list-disc list-inside text-left">
        ...
        <div className="w-full max-w-4xl mx-auto mb-10">
          <h2 className="text-3xl md:text-4xl font-extrabold text-primary text-center mb-10">Meet Our Team</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {[1,2,3,4,5,6].map(i => (
              <div key={i} className="bg-card text-foreground rounded-2xl shadow-xl p-8 flex flex-col items-center border border-border backdrop-blur-md transition-all">
                ...
                <h3 className="text-xl font-bold text-primary mb-1">John Doe {i}</h3>
                <p className="text-foreground mb-2">Role: Product Manager</p>
                <p className="text-muted-foreground text-center text-sm">Passionate about building world-class products and helping people grow their careers.</p>
              </div>
            ))}
          </div>
        </div>
