  ...
  return (
    <section className="relative flex flex-col items-center justify-center pt-6 pb-6 px-2 sm:pt-10 sm:pb-8 sm:px-4">
      <div className="relative w-full max-w-4xl mx-auto flex flex-col items-center justify-center min-h-[220px] sm:min-h-[320px]">
        ...
        <Image src="https://img.logo.dev/google.com?token=pk_GXHi5vUDRwm1xphnJaliqA" alt="Google" width={24} height={24} className="hidden sm:block absolute left-[-70px] top-[40px] rounded-xl shadow-lg border-2 border-blue-100 bg-white animate-roam1" />
        <Image src="https://img.logo.dev/linkedin.com?token=pk_GXHi5vUDRwm1xphnJaliqA" alt="LinkedIn" width={24} height={24} className="hidden sm:block absolute left-[-70px] top-[130px] rounded-xl shadow-lg border-2 border-blue-100 bg-white animate-roam2" />
        <Image src="https://img.logo.dev/meta.com?token=pk_GXHi5vUDRwm1xphnJaliqA" alt="Meta" width={24} height={24} className="hidden sm:block absolute left-[-70px] top-[220px] rounded-xl shadow-lg border-2 border-blue-100 bg-white animate-roam3" />
        <Image src="https://img.logo.dev/amazon.com?token=pk_GXHi5vUDRwm1xphnJaliqA" alt="Amazon" width={24} height={24} className="hidden sm:block absolute right-[-70px] top-[40px] rounded-xl shadow-lg border-2 border-blue-100 bg-white animate-roam4" />
