    ...
    <section className="relative flex flex-col items-center justify-center pt-6 pb-6 px-2 sm:pt-10 sm:pb-8 sm:px-4">
      <div className="relative w-full max-w-4xl mx-auto flex flex-col items-center justify-center min-h-[220px] sm:min-h-[320px]">
        ...
        <div className="flex flex-col items-center z-10 relative w-full">
          <span className="inline-flex items-center gap-1 text-[10px] sm:text-xs font-bold bg-gradient-to-r from-blue-500 to-blue-700 text-white dark:from-primary dark:to-primary/80 dark:text-primary-foreground px-2 sm:px-3 py-0.5 sm:py-1 rounded-full mb-2 mt-1 shadow-lg tracking-wide">
          ...
          <h1 className="font-space-grotesk text-xl sm:text-2xl md:text-4xl font-black tracking-tight leading-[1.15] text-center mb-3 sm:mb-4 text-gray-900 dark:text-foreground">
            Search,<span className="text-blue-600 dark:text-primary">Apply</span> &<br />Get Your <span className="text-blue-600 dark:text-primary">Dream Job</span>
          </h1>
          <p className="text-sm sm:text-base md:text-lg text-gray-500 dark:text-muted-foreground text-center max-w-xs sm:max-w-2xl mb-3 sm:mb-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 mt-4 mb-6 w-full max-w-xs sm:max-w-none">
            <button
              className="w-full sm:w-auto px-5 py-2.5 bg-gradient-to-r from-blue-500 to-blue-700 text-white dark:from-primary dark:to-primary/80 dark:text-primary-foreground font-bold rounded-full shadow-md hover:from-blue-600 hover:to-blue-800 dark:hover:from-primary/80 dark:hover:to-primary transition text-base flex items-center justify-center gap-2 border-2 border-blue-500 dark:border-primary"
              onClick={onBrowseJobsClick}
            >
              <FaBriefcase className="w-4 h-4 mr-1" /> Browse Jobs
            </button>
            <button
              className="w-full sm:w-auto px-5 py-2.5 bg-blue-600 text-white dark:bg-primary dark:text-primary-foreground font-bold rounded-full shadow-md hover:bg-blue-700 dark:hover:bg-primary/80 transition text-base flex items-center justify-center gap-2 border-2 border-blue-500 dark:border-primary"
